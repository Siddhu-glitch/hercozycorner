...
<head>
  ...
  <style>
    ...
    .card, .message, .affirmation, .breathing {
...
<body>
  ...
  <script>
    const loveNotes = [
      ...
      "Sometimes the bravest thing is to rest 💪",
    ...
    const treats = [
      ...
      "🎈 Decorate your space with something cute",
    ...
    const compliments = [
      ...
      "You, my dear, are divine—even on Day 1 🌙"
    ];
